...
def get_keys(account):
    ...
    keys = json.loads(subprocess.Popen(["cline", "wallet", "private_keys", "--password", "PW5KMczH1rHrLQby35BPpbRQWHoEhLtN4ScgyWYhjAaKcqzcxZv1k"], stdout = subprocess.PIPE).communicate()[0].decode())
